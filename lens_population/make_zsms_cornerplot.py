...
catpars = ['zobs', 'i_SDSS_apparent_corr']
pars = ['zs', 'smag']
npars = len(pars)
...
labels = ['$z_{\mathrm{s}}$', '$m_{\mathrm{s}}$']

lims = [(0.8, 2.5), (21., 28.5)]

major_step = [1, 2]
minor_step = [0.2, 0.5]

fig = pylab.figure()
pylab.subplots_adjust(left=0.1, right=0.99, bottom=0.13, top=0.99, hspace=0.1, wspace=0.1)
...
pylab.savefig('../paper/zsms_cornerplot.pdf')
pylab.show()
