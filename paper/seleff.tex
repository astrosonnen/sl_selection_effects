...
Time-delay measurements of $H_0$ from lensed quasars can take advantage of prior information obtained from galaxy-galaxy lenses with similar Einstein radius.
}
   \keywords{
...
\item The system must be recognised as a lens by the survey.
\end{enumerate}
...
\Fref{fig:minmulbias} and \Fref{fig:minmusbias} show the strong lensing bias on a series of lens- and source-related properties.
Besides the change in the source redshift and magnitude (first two panels in \Fref{fig:minmusbias}), we see very little differences in the bias with respect to the peak-based definition of the fiducial analysis. We then conclude that the exact definition of a strong lensing event does not have a big impact on the strong lensing bias of lens-related properties.
