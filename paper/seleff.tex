...
All of the examples that we considered were based on sources with a single surface brightness peaks.
...
We applied two different lens selection criteria.
First, we used the criterion described in section \ref{ssec:lensdetext}.
...
\Fref{fig:lenspars} shows the distribution in the parameters of the foreground galaxies of the lens systems, compared to those of the general population.
