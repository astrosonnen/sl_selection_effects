...
\end{equation}
The existence of a fundamental plane relation is a consequence of the virial theorem: the velocity dispersion of a galaxy is directly related to the 3-dimensional mass distribution in its inner regions, which is tyically dominated by the stellar component.
...
We generated samples of early-type galaxies with the recipes described above and with different values of $\sigma_{\mathrm{sps}}$, $\sigma_h$ and $\sigma_\gamma$.
...
The details of this procedures are given in Appendix~\ref{sect:appendixb}.
...
We then generated samples of galaxies from the model of section \ref{ssec:lenses}.
...
%First, we took the sample of SDSS early-type galaxies introduced in Appendix~\ref{sect:appendixa}
