...
We drew halo masses from the following distribution:
\begin{equation}
...
The the intrinsic scatter in halo mass is more uncertain from an observational point of view, therefore we ran simulations with different values of $\sigma_h$, as for the stellar population synthesis mismatch parameter.

%which is similar to current weak lensing constraints on the halo mass distribution of elliptical galaxies \citep{Son++22}.
