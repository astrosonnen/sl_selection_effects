...
The total number of strong lenses increases by $34\%$ with this new definition, mostly due to the inclusion of fainter sources with no detected multiple images.
...
%However, many previous simulation studies adopted criteria based on magnification \citep[see e.g.][]{Col15, Rob++20}.
 
However, in the literature it is common to find alternative criteria based on magnification \citep[see e.g.][]{Col15, 

it is common to find 
In the 
Other simulation works, however, use a


Our analysis was based on the definition of a strong lens given in sections \ref{ssec:lensdefpoint} and \ref{ssec:lensdefext}. 
These are not the only possible definitions.
In the case of an extended source, in particular, it is common to find in the literature magnification-based 
