...
labels = ['$\log{M_*}$', '$\log{M_{\mathrm{h}}}$']

lims = [(11., 12.2), (11.8, 14.4)]

major_step = [0.5, 1]
minor_step = [0.1, 0.2]

fig = pylab.figure()
pylab.subplots_adjust(left=0.10, right=0.99, bottom=0.16, top=0.99, hspace=0.1, wspace=0.1)
...
pylab.savefig('../paper/mstarmh_cornerplot.pdf')
pylab.show()
