...
%For this reason, the best known examples of strong lensing in the large source size regime are produced by objects with a relatively low brightness that act as perturbers on images that are strongly lensed by a larger mass \citep[see e.g.][]{Veg++12}.
