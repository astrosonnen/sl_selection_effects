...
This is the lens model used to produce the caustics plot of \Fref{Fig:caustics}.
...
%\Fref{fig:caustics} shows that the area enclosed within the tangential caustic is a strong function of the lens ellipticity.
