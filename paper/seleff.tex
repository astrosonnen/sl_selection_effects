...
\begin{document} 
   ...
   \author{Alessandro Sonnenfeld\inst{\ref{sjtu},\ref{leiden}}\and
           ...
           Anowar Shajib\inst{\ref{chicago},\ref{kicp},\ref{einstein}}\and
...
%Galaxies selected in velocity dispersion are similar to existing samples of lenses in terms of other observable quantities
